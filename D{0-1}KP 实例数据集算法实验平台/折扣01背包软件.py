...
#读取文件
fileNum=int(input('1、idkp1-10.txt\n2、sdkp1-10.txt\n3、udkp1-10.txt\n4、wdkp1-10.txt\n希望读取的文件（1~4）：'))
if (fileNum==1):
...
i=int(input('希望查找第几组数据（0~10）(除文件1外其他文件没有第0组数据)：'))
...
print('(num,profit,weight)')
for j in range(0,d):
    print(result[j])

#输出重要数据
print('背包最大容量：',cubage[i])
print('物品价值：',profit[i])
print('物品重量：',weight[i])
print('价值：重量比：',pw[i])
...
print('按价值：重量比对项集第三项进行降序排序：',third)
